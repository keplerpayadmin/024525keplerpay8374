...
export function ConnectButton({ onClick, isConnected, onConnect }: ConnectButtonProps) {
  ...
  const [language, setLanguage] = useState<"en" | "pt" | "es" | "id">(getCurrentLanguage())
  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      const walletAuthInput: WalletAuthInput = {
        ...
        statement: "Connect your wallet to KeplerPay to access the token ecosystem on Worldchain.", // Alterado para KeplerPay
      }
