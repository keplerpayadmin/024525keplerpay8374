...
import { TOKENS_BY_SYMBOL } from "@/services/token-registry"

// Definindo TOKENS para corresponder ao token registry
const TOKENS = Object.values(TOKENS_BY_SYMBOL)
  ...
  const handleSwap = useCallback(async () => {
    ...
    try {
      ...
      const swapResult = await doSwap({
        ...
        quote: swapQuote,
        amountIn: cleanAmount,
        tokenInSymbol: swapForm.tokenFrom as any,
        tokenOutSymbol: swapForm.tokenTo as any,
      })
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-gray-600 hover:bg-gray-700 disabled:bg-gray-400 disabled:opacity-50 text-white font-medium py-1.5 px-3 rounded-lg transition-colors flex items-center justify-center space-x-2"
                >
                  {sending ? (
                    <>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-center">
                  <button
                    ...
                    className="p-2 bg-gray-300/50 hover:bg-gray-400/50 rounded-full transition-colors text-gray-800"
                    title="Swap tokens"
                  >
