...
const quizThemes = {
  ...
  crypto: {
    ...
    description: "Test your knowledge of KeplerPay, WorldChain Alliance, and cryptocurrency",
    color: "green",
    questions: [
      {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl w-full">
          {Object.entries(quizThemes).map(([key, theme]) => {
            ...
            return (
              <div
                key={key}
                className={`bg-gradient-to-br ${colors.bg} border-2 ${colors.border} cursor-pointer transform transition-all duration-300 hover:scale-105 ${colors.hover} shadow-2xl rounded-lg p-8 text-center`}
                onClick={() => selectTheme(key)}
              >
                <h3 className="text-2xl font-bold mb-6 text-white">{theme.title}</h3>
                <div className="mt-4">
                  <div
                    className={`inline-flex items-center rounded-full px-4 py-2 text-sm font-semibold ${colors.accent} text-white border-none`}
                  >
                    25 Questions
                  </div>
                </div>
        ...
        {showKppModal && (
          <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50">
            <div className="bg-gradient-to-br from-yellow-600 to-yellow-800 p-8 rounded-2xl text-center max-w-md mx-4 border-4 border-yellow-400 shadow-2xl">
              ...
              <p className="text-xl text-yellow-100 mb-6">You earned 10 KPP!</p>
              <Button
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-4">
              <Button onClick={goBackToThemes} className="bg-gray-700 hover:bg-gray-600 text-white p-2 rounded-full">
            ...
            <div className="text-right">
              ...
              <div className="text-lg text-yellow-400">KPP: {kppEarned}</div>
            </div>
          </div>
      ...
      <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-4">
        <div className="text-center max-w-2xl">
          ...
          <div className="flex gap-4 justify-center">
            ...
            <Button
              onClick={() => selectTheme(Object.keys(quizThemes).find((key) => quizThemes[key] === selectedTheme))}
