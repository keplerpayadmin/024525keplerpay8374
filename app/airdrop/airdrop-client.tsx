      ...
      <div className="flex-1 flex flex-col items-center justify-center relative z-10 text-center px-4">
        ...
        <AnimatePresence>
          {showCountdown && isInCooldown && (
            ...
            >
              <div className="bg-gray-900/80 backdrop-blur-sm border border-gray-700/50 rounded-xl p-3 shadow-2xl">
                <div className="flex items-center justify-center gap-2 mb-2">
                  <Clock className="w-3 h-3 text-cyan-400" />
                  <span className="text-cyan-400 font-medium text-xs">{t.airdrop.nextClaimIn}</span>
                </div>
                ...
                <div className="flex items-center justify-center gap-2">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-[10px] text-gray-400 uppercase tracking-wider">{t.airdrop.hours}</div>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-[10px] text-gray-400 uppercase tracking-wider">{t.airdrop.minutes}</div>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-[10px] text-gray-400 uppercase tracking-wider">{t.airdrop.seconds}</div>
                  </div>
                </div>
        ...
        <AnimatePresence>
          {showClaimButton && !showCountdown && !isInCooldown && (
            ...
            >
              {/* KeplerPay Logo */}
              <motion.div
                className="relative w-12 h-12 mb-6" // Changed mb-40 to mb-12
              ...
              {/* Claim Button */}
              <button
                className={`w-28 py-1.5 px-3 rounded-full ${
                  showClaimButton
                ...
                } font-bold text-xs shadow-lg border border-gray-300/30 relative overflow-hidden hover:scale-105 active:scale-95 transition-all duration-200`}
              ...
              >
                ...
                <div className="relative flex items-center justify-center gap-1">
                  {isClaiming ? (
                    <>
                      <div className="w-3 h-3 border-2 border-t-gray-800 border-gray-400 rounded-full animate-spin" />
